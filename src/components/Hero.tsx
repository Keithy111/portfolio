...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative pt-20 pb-16 overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-90 text-center relative z-10">
        ...
        <div className="flex justify-center gap-6 mb-8">
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/keithyeung11/"
            target="_blank"
          ...
          {/* GitHub */}
          <a
            href="https://github.com/Keithy111"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* Email */}
          <a
            href="mailto:keithy0157@gmail.com"
